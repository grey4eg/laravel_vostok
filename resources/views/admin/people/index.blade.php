        ...
        @if ( !empty($peoples) )
          ...
          @foreach ($peoples as $people)
            <tr>
              <td>{{ $people->id }}</td>
              <td>
                <form method="POST" action="{{ route('admin.people.loadPdf', $people->id) }}" class="d-inline me-2">
                  @csrf
                ...
                <a href="{{ route('admin.people.show', $people->id) }}" target="_blank">{{ $people->Lastname }} {{ $people->FirstName }} {{ $people->Secondname }}</a>
              </td>
              <td>{{ $people->Debt }}</td>
              <td>{{ $people->StateFee }}</td>
